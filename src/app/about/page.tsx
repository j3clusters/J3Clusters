    ...
    <SiteArticlePage
      ...
      intro={
        <p className="site-article-lead">
          ...
          listing workflows, and direct access to consultants when you need it.
        </p>
      }
    >
      <h2>Our purpose</h2>
      <p>
        J3 Clusters brings together buyers, tenants, and property consultants so
      ...
      <ul className="site-article-list">
        <li>
          <strong>Verified listings pathway</strong> — consultant submissions move
        ...
        <li>
          ...
          (sale versus rent), key facts, and—where appropriate—consultant contact
          access for authenticated community members.
        </li>
        <li>
          <strong>Support</strong> — whether you browse as a visitor, join as a
          community member, or list properties as a consultant, we aim to respond
